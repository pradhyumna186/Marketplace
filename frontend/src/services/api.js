...
export const fileAPI = {
  uploadProductImages: (files) => {
    ...
    return api.post('/files/upload/product-images', formData, {
  ...
  uploadCategoryIcon: (file) => {
    ...
    return api.post('/files/upload/category-icon', formData, {
      headers: { 'Content-Type': 'multipart/form-data' }
    });
  },
};
...
export const adminAPI = {
  ...
  rejectCategoryRequest: (id, reviewNotes) => api.post(`/admin/category-requests/${id}/reject?reviewNotes=${reviewNotes}`),
};
